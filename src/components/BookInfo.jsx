...
const BookInfo = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await getBook(`books/${book._id}`);
        ...
        <div className="right-div">
            ...
            <div className="o-rating">
              ...
              <div className="review">
                <input
                  ...
                  className="wyr"
                />
                <div className="b-d"><button className="s-button">Submit</button></div>
              </div>
            </div>
          </div>
          <div className="ratings">
            <div className="c-rating">
                ...
                <Avatar sx={{ width: "25px", height: "25px", fontSize: "12px" }}>HS</Avatar>
                ...
                <div className="r-info">
                    <span>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quis repudiandae molestias sunt nam voluptatibus earum quam quidem obcaecati officia ipsum.</span>
                </div>
            </div>
            <div className="c-rating">
                <div className="c-info">
                <Avatar sx={{ width: "25px", height: "25px", fontSize: "12px" }}>MD</Avatar>
                ...
                <div className="r-info">
                    <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusantium, fugit ratione. Sint et itaque libero. Inventore culpa nulla amet veritatis!</span>
                </div>
                </div>
          </div>
        </div>
